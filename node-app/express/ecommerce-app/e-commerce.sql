...
create table products(product_guid int,name varchar(20),image varchar(20),description varchar(100),price int,product_category varchar(20),primary key(product_guid), foreign key (product_category) references category(product_category));
